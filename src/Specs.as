...
public class Specs {
	...
	public static const obsoleteCategory:int = 14;
	...
	public static const categories:Array = [
	 // id   category name	color
		...
		[12, "List",		listColor],
		[13, "Literals",	0x72A6A8],
		[14, "Obsolete",	undefinedColor],
		[20, "Extension",	extensionsColor],
	];

	public static function blockColor(categoryID:int):int {
		if (categoryID > 100) categoryID = categoryID % 100;
	...
	public static var commands:Array = [
		...
		["null",								"r", 13, "null"],
		["-"],
		["Infinity",							"r", 13, "Infinity"],
		["-Infinity",							"r", 13, "-Infinity"],
		["-"],
		["NaN",									"r", 13, "NaN"],
		["-"],
		["hex %h",								"r", 13, "hexValue", "0xffffff"],

		// Obsolete working sound
		["play drum %n for %n beats",			" ", 203, "drum:duration:elapsed:from:", 1, 0.25], // Scratch 1.4 MIDI drum
		["set instrument to %n",				" ", 203, "midiInstrument:", 1],
		
		// Obsolete broken motion
		["scroll right %n",						" ", 301, "scrollRight",		10],
		["scroll up %n",						" ", 301, "scrollUp",		10],
		["align scene %m.scrollAlign",			" ", 301, "scrollAlign",		'bottom-left'],
		["x scroll",							"r", 301, "xScroll"],
		["y scroll",							"r", 301, "yScroll"],
		
		// Obsolete broken looks
		["hide all sprites",					" ", 302, "hideAll"],
		
		// Obsolete broken control
		["all at once",							"c", 306, "warpSpeed"],
		
		// Obsolete broken sensing
		["user id",								"r", 307, "getUserId"],
